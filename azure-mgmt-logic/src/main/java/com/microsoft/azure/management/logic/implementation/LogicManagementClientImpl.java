...
import com.microsoft.azure.management.logic.ErrorResponseException;
...
public class LogicManagementClientImpl extends AzureServiceClient {
    ...
    interface LogicManagementClientService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.logic.LogicManagementClient listOperations" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.logic.LogicManagementClient listOperationsNext" })
        @GET
