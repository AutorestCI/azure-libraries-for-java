...
public class WorkflowRunActionScopedRepetitionsInner {
    ...
    interface WorkflowRunActionScopedRepetitionsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.logic.WorkflowRunActionScopedRepetitions list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.logic.WorkflowRunActionScopedRepetitions get" })
