...
public class ApplicationHealthPolicy {
    ...
    private List<ServiceTypeHealthPolicyMapItem> serviceTypeHealthPolicies;
     ...
     */
    public List<ServiceTypeHealthPolicyMapItem> serviceTypeHealthPolicies() {
     ...
     * @return the ApplicationHealthPolicy object itself.
     */
    public ApplicationHealthPolicy withServiceTypeHealthPolicies(List<ServiceTypeHealthPolicyMapItem> serviceTypeHealthPolicies) {
