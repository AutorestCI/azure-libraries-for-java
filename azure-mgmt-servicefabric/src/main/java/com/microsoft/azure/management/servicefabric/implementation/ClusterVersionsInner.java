...
public class ClusterVersionsInner {
    ...
    interface ClusterVersionsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.servicefabric.ClusterVersions get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.servicefabric.ClusterVersions getByEnvironment" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.servicefabric.ClusterVersions listByEnvironment" })
     ...
     */
    public ClusterCodeVersionsListResultInner get(String location, String subscriptionId, String clusterVersion) {
        return getWithServiceResponseAsync(location, subscriptionId, clusterVersion).toBlocking().single().body();
    }
     ...
     */
    public ServiceFuture<ClusterCodeVersionsListResultInner> getAsync(String location, String subscriptionId, String clusterVersion, final ServiceCallback<ClusterCodeVersionsListResultInner> serviceCallback) {
        return ServiceFuture.fromResponse(getWithServiceResponseAsync(location, subscriptionId, clusterVersion), serviceCallback);
    }
     ...
     */
    public Observable<ClusterCodeVersionsListResultInner> getAsync(String location, String subscriptionId, String clusterVersion) {
        return getWithServiceResponseAsync(location, subscriptionId, clusterVersion).map(new Func1<ServiceResponse<ClusterCodeVersionsListResultInner>, ClusterCodeVersionsListResultInner>() {
            @Override
     ...
     * @return the observable to the ClusterCodeVersionsListResultInner object
     */
    public Observable<ServiceResponse<ClusterCodeVersionsListResultInner>> getWithServiceResponseAsync(String location, String subscriptionId, String clusterVersion) {
        if (location == null) {
     ...
     * @return the ClusterCodeVersionsListResultInner object if successful.
     */
    public ClusterCodeVersionsListResultInner getByEnvironment(String location, String environment, String subscriptionId, String clusterVersion) {
        return getByEnvironmentWithServiceResponseAsync(location, environment, subscriptionId, clusterVersion).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<ClusterCodeVersionsListResultInner> getByEnvironmentAsync(String location, String environment, String subscriptionId, String clusterVersion, final ServiceCallback<ClusterCodeVersionsListResultInner> serviceCallback) {
        return ServiceFuture.fromResponse(getByEnvironmentWithServiceResponseAsync(location, environment, subscriptionId, clusterVersion), serviceCallback);
    }
     ...
     * @return the observable to the ClusterCodeVersionsListResultInner object
     */
    public Observable<ClusterCodeVersionsListResultInner> getByEnvironmentAsync(String location, String environment, String subscriptionId, String clusterVersion) {
        return getByEnvironmentWithServiceResponseAsync(location, environment, subscriptionId, clusterVersion).map(new Func1<ServiceResponse<ClusterCodeVersionsListResultInner>, ClusterCodeVersionsListResultInner>() {
            @Override
            public ClusterCodeVersionsListResultInner call(ServiceResponse<ClusterCodeVersionsListResultInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the ClusterCodeVersionsListResultInner object
     */
    public Observable<ServiceResponse<ClusterCodeVersionsListResultInner>> getByEnvironmentWithServiceResponseAsync(String location, String environment, String subscriptionId, String clusterVersion) {
        if (location == null) {
            throw new IllegalArgumentException("Parameter location is required and cannot be null.");
        }
        if (environment == null) {
     ...
     * @return the ClusterCodeVersionsListResultInner object if successful.
     */
    public ClusterCodeVersionsListResultInner list(String location, String subscriptionId) {
        return listWithServiceResponseAsync(location, subscriptionId).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<ClusterCodeVersionsListResultInner> listAsync(String location, String subscriptionId, final ServiceCallback<ClusterCodeVersionsListResultInner> serviceCallback) {
        return ServiceFuture.fromResponse(listWithServiceResponseAsync(location, subscriptionId), serviceCallback);
    }
     ...
     * @return the observable to the ClusterCodeVersionsListResultInner object
     */
    public Observable<ClusterCodeVersionsListResultInner> listAsync(String location, String subscriptionId) {
        return listWithServiceResponseAsync(location, subscriptionId).map(new Func1<ServiceResponse<ClusterCodeVersionsListResultInner>, ClusterCodeVersionsListResultInner>() {
            @Override
            public ClusterCodeVersionsListResultInner call(ServiceResponse<ClusterCodeVersionsListResultInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the ClusterCodeVersionsListResultInner object
     */
    public Observable<ServiceResponse<ClusterCodeVersionsListResultInner>> listWithServiceResponseAsync(String location, String subscriptionId) {
        if (location == null) {
            throw new IllegalArgumentException("Parameter location is required and cannot be null.");
        }
        if (subscriptionId == null) {
     ...
     * @return the ClusterCodeVersionsListResultInner object if successful.
     */
    public ClusterCodeVersionsListResultInner listByEnvironment(String location, String environment, String subscriptionId) {
        return listByEnvironmentWithServiceResponseAsync(location, environment, subscriptionId).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<ClusterCodeVersionsListResultInner> listByEnvironmentAsync(String location, String environment, String subscriptionId, final ServiceCallback<ClusterCodeVersionsListResultInner> serviceCallback) {
        return ServiceFuture.fromResponse(listByEnvironmentWithServiceResponseAsync(location, environment, subscriptionId), serviceCallback);
    }
     ...
     * @return the observable to the ClusterCodeVersionsListResultInner object
     */
    public Observable<ClusterCodeVersionsListResultInner> listByEnvironmentAsync(String location, String environment, String subscriptionId) {
        return listByEnvironmentWithServiceResponseAsync(location, environment, subscriptionId).map(new Func1<ServiceResponse<ClusterCodeVersionsListResultInner>, ClusterCodeVersionsListResultInner>() {
            @Override
            public ClusterCodeVersionsListResultInner call(ServiceResponse<ClusterCodeVersionsListResultInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the ClusterCodeVersionsListResultInner object
     */
    public Observable<ServiceResponse<ClusterCodeVersionsListResultInner>> listByEnvironmentWithServiceResponseAsync(String location, String environment, String subscriptionId) {
        if (location == null) {
            throw new IllegalArgumentException("Parameter location is required and cannot be null.");
        }
        if (environment == null) {
