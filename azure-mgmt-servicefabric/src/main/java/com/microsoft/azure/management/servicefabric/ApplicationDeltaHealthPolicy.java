...
public class ApplicationDeltaHealthPolicy {
    ...
    private List<ServiceTypeDeltaHealthPolicyMapItem> serviceTypeDeltaHealthPolicies;
     ...
     */
    public List<ServiceTypeDeltaHealthPolicyMapItem> serviceTypeDeltaHealthPolicies() {
     ...
     * @return the ApplicationDeltaHealthPolicy object itself.
     */
    public ApplicationDeltaHealthPolicy withServiceTypeDeltaHealthPolicies(List<ServiceTypeDeltaHealthPolicyMapItem> serviceTypeDeltaHealthPolicies) {
