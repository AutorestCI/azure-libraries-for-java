...
public class SpellCheckAPIImpl extends AzureServiceClient {
     ...
     */
    public SpellCheckInner spellChecker(String text) {
     ...
     */
    public ServiceFuture<SpellCheckInner> spellCheckerAsync(String text, final ServiceCallback<SpellCheckInner> serviceCallback) {
     ...
     */
    public Observable<SpellCheckInner> spellCheckerAsync(String text) {
        return spellCheckerWithServiceResponseAsync(text).map(new Func1<ServiceResponse<SpellCheckInner>, SpellCheckInner>() {
            @Override
     ...
     * @return the observable to the SpellCheckInner object
     */
    public Observable<ServiceResponse<SpellCheckInner>> spellCheckerWithServiceResponseAsync(String text) {
        if (text == null) {
        ...
        return service.spellChecker(xBingApisSDK, acceptLanguage, pragma, this.userAgent(), clientId, clientIp, location, actionType, appName, countryCode, clientMachineName, docId, market, sessionId, setLang, userId, mode, preContextText, postContextText, text, this.userAgent())
     ...
     * @return the SpellCheckInner object if successful.
     */
    public SpellCheckInner spellChecker(String text, String acceptLanguage, String pragma, String clientId, String clientIp, String location, ActionType actionType, String appName, String countryCode, String clientMachineName, String docId, String market, String sessionId, String setLang, String userId, String mode, String preContextText, String postContextText) {
        return spellCheckerWithServiceResponseAsync(text, acceptLanguage, pragma, clientId, clientIp, location, actionType, appName, countryCode, clientMachineName, docId, market, sessionId, setLang, userId, mode, preContextText, postContextText).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<SpellCheckInner> spellCheckerAsync(String text, String acceptLanguage, String pragma, String clientId, String clientIp, String location, ActionType actionType, String appName, String countryCode, String clientMachineName, String docId, String market, String sessionId, String setLang, String userId, String mode, String preContextText, String postContextText, final ServiceCallback<SpellCheckInner> serviceCallback) {
        return ServiceFuture.fromResponse(spellCheckerWithServiceResponseAsync(text, acceptLanguage, pragma, clientId, clientIp, location, actionType, appName, countryCode, clientMachineName, docId, market, sessionId, setLang, userId, mode, preContextText, postContextText), serviceCallback);
    }
     ...
     * @return the observable to the SpellCheckInner object
     */
    public Observable<SpellCheckInner> spellCheckerAsync(String text, String acceptLanguage, String pragma, String clientId, String clientIp, String location, ActionType actionType, String appName, String countryCode, String clientMachineName, String docId, String market, String sessionId, String setLang, String userId, String mode, String preContextText, String postContextText) {
        return spellCheckerWithServiceResponseAsync(text, acceptLanguage, pragma, clientId, clientIp, location, actionType, appName, countryCode, clientMachineName, docId, market, sessionId, setLang, userId, mode, preContextText, postContextText).map(new Func1<ServiceResponse<SpellCheckInner>, SpellCheckInner>() {
            @Override
            public SpellCheckInner call(ServiceResponse<SpellCheckInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the SpellCheckInner object
     */
    public Observable<ServiceResponse<SpellCheckInner>> spellCheckerWithServiceResponseAsync(String text, String acceptLanguage, String pragma, String clientId, String clientIp, String location, ActionType actionType, String appName, String countryCode, String clientMachineName, String docId, String market, String sessionId, String setLang, String userId, String mode, String preContextText, String postContextText) {
        if (text == null) {
            throw new IllegalArgumentException("Parameter text is required and cannot be null.");
        }
        final String xBingApisSDK = "true";
    ...
    private ServiceResponse<SpellCheckInner> spellCheckerDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
