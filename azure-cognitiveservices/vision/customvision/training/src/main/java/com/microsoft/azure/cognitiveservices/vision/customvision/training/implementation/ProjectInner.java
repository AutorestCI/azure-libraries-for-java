...
import com.microsoft.azure.cognitiveservices.vision.customvision.training.ProjectSettings;
...
public class ProjectInner {
     ...
     */
    public ProjectInner withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ProjectInner object itself.
     */
    public ProjectInner withSettings(ProjectSettings settings) {
    ...
    /**
     * Get gets the date this project was last modifed.
     *
