...
public class IterationInner {
     ...
     * @return the IterationInner object itself.
     */
    public IterationInner withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the IterationInner object itself.
     */
    public IterationInner withIsDefault(boolean isDefault) {
