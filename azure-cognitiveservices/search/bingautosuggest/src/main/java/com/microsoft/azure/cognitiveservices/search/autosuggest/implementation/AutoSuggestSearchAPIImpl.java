...
import com.microsoft.azure.cognitiveservices.search.autosuggest.ErrorResponseException;
import com.microsoft.azure.cognitiveservices.search.autosuggest.ResponseFormat;
import com.microsoft.azure.cognitiveservices.search.autosuggest.SafeSearch;
...
/**
 * Initializes a new instance of the AutoSuggestSearchAPIImpl class.
 */
public class AutoSuggestSearchAPIImpl extends AzureServiceClient {
    /** The Retrofit service to perform REST calls. */
    private AutoSuggestSearchAPIService service;
     ...
     */
    public AutoSuggestSearchAPIImpl withAcceptLanguage(String acceptLanguage) {
     ...
     * @return the service client itself
     */
    public AutoSuggestSearchAPIImpl withLongRunningOperationRetryTimeout(int longRunningOperationRetryTimeout) {
     ...
     * @return the service client itself
     */
    public AutoSuggestSearchAPIImpl withGenerateClientRequestId(boolean generateClientRequestId) {
        this.generateClientRequestId = generateClientRequestId;
        return this;
    }

    /**
     * Initializes an instance of AutoSuggestSearchAPI client.
     *
     * @param credentials the management credentials for Azure
     */
    public AutoSuggestSearchAPIImpl(ServiceClientCredentials credentials) {
     ...
     * @param credentials the management credentials for Azure
     */
    public AutoSuggestSearchAPIImpl(String baseUrl, ServiceClientCredentials credentials) {
     ...
     */
    public AutoSuggestSearchAPIImpl(RestClient restClient) {
        super(restClient);
        initialize();
    }
    ...
    public String userAgent() {
        return String.format("%s (%s, %s)", super.userAgent(), "AutoSuggestSearchAPI", "1.0");
    }

    private void initializeService() {
        service = restClient().retrofit().create(AutoSuggestSearchAPIService.class);
    }

    /**
     * The interface defining all the services for AutoSuggestSearchAPI to be
