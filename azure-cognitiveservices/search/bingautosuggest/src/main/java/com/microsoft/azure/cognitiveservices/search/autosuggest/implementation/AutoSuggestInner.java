...
@JsonTypeName("AutoSuggest")
public class AutoSuggestInner extends SearchResultsAnswer {
    /**
     ...
     * @return the AutoSuggestInner object itself.
     */
    public AutoSuggestInner withSuggestionGroups(List<SuggestionsSuggestionGroup> suggestionGroups) {
