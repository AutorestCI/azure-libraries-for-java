 ...
 */
@JsonFlatten
public class ShortTermRetentionPolicyInner extends ProxyResourceInner {
    /**
     ...
     * @return the ShortTermRetentionPolicyInner object itself.
     */
    public ShortTermRetentionPolicyInner withRetentionDays(Integer retentionDays) {
