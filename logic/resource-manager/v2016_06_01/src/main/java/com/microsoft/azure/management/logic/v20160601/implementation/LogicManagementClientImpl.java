...
public class LogicManagementClientImpl extends AzureServiceClient {
    ...
    interface LogicManagementClientService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.logic.v20160601.LogicManagementClient listOperations" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.logic.v20160601.LogicManagementClient listOperationsNext" })
        @GET
