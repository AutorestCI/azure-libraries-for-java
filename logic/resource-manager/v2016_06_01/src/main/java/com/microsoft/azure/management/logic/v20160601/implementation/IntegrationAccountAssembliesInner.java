...
public class IntegrationAccountAssembliesInner {
    ...
    interface IntegrationAccountAssembliesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.logic.v20160601.IntegrationAccountAssemblies list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.logic.v20160601.IntegrationAccountAssemblies get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.logic.v20160601.IntegrationAccountAssemblies createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.logic.v20160601.IntegrationAccountAssemblies delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.logic.v20160601.IntegrationAccountAssemblies listContentCallbackUrl" })
