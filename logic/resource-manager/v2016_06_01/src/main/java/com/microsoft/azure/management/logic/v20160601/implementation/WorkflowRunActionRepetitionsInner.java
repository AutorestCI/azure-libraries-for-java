...
public class WorkflowRunActionRepetitionsInner {
    ...
    interface WorkflowRunActionRepetitionsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.logic.v20160601.WorkflowRunActionRepetitions list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.logic.v20160601.WorkflowRunActionRepetitions get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.logic.v20160601.WorkflowRunActionRepetitions listExpressionTraces" })
