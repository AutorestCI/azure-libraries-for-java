...
public final class CertificateRegistrationManager extends Manager<CertificateRegistrationManager, WebSiteManagementClientImpl> {
    /**
    ...
    */
    public interface Configurable extends AzureConfigurable<Configurable> {
        /**
        * Creates an instance of CertificateRegistrationManager that exposes CertificateRegistration management API entry points.
        *
        * @param credentials the credentials to use
        * @param subscriptionId the subscription UUID
