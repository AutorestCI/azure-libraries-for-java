...
public class CertificateRegistrationProvidersInner {
    ...
    interface CertificateRegistrationProvidersService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.appservice.v20180201.CertificateRegistrationProviders listOperations" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.appservice.v20180201.CertificateRegistrationProviders listOperationsNext" })
        @GET
