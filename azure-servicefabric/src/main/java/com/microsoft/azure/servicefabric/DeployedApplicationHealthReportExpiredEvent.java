...
public class DeployedApplicationHealthReportExpiredEvent extends ApplicationEventInner {
    /**
     ...
     */
    public DeployedApplicationHealthReportExpiredEvent withApplicationInstanceId(long applicationInstanceId) {
     ...
     * @return the DeployedApplicationHealthReportExpiredEvent object itself.
     */
    public DeployedApplicationHealthReportExpiredEvent withNodeName(String nodeName) {
     ...
     * @return the DeployedApplicationHealthReportExpiredEvent object itself.
     */
    public DeployedApplicationHealthReportExpiredEvent withSourceId(String sourceId) {
     ...
     * @return the DeployedApplicationHealthReportExpiredEvent object itself.
     */
    public DeployedApplicationHealthReportExpiredEvent withProperty(String property) {
     ...
     * @return the DeployedApplicationHealthReportExpiredEvent object itself.
     */
    public DeployedApplicationHealthReportExpiredEvent withHealthState(String healthState) {
     ...
     * @return the DeployedApplicationHealthReportExpiredEvent object itself.
     */
    public DeployedApplicationHealthReportExpiredEvent withTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the DeployedApplicationHealthReportExpiredEvent object itself.
     */
    public DeployedApplicationHealthReportExpiredEvent withSequenceNumber(long sequenceNumber) {
     ...
     * @return the DeployedApplicationHealthReportExpiredEvent object itself.
     */
    public DeployedApplicationHealthReportExpiredEvent withDescription(String description) {
     ...
     * @return the DeployedApplicationHealthReportExpiredEvent object itself.
     */
    public DeployedApplicationHealthReportExpiredEvent withRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the DeployedApplicationHealthReportExpiredEvent object itself.
     */
    public DeployedApplicationHealthReportExpiredEvent withSourceUtcTimestamp(DateTime sourceUtcTimestamp) {
