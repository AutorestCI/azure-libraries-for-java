 ...
 * this list.
 */
public class PagedApplicationInfoListInner {
    /**
    ...
    private List<ApplicationInfoInner> items;
     ...
     * @return the PagedApplicationInfoListInner object itself.
     */
    public PagedApplicationInfoListInner withContinuationToken(String continuationToken) {
     ...
     */
    public List<ApplicationInfoInner> items() {
        return this.items;
    }
     ...
     * @return the PagedApplicationInfoListInner object itself.
     */
    public PagedApplicationInfoListInner withItems(List<ApplicationInfoInner> items) {
        this.items = items;
        return this;
    }
