...
@JsonTypeName("StatelessReplicaHealthReportCreated")
public class StatelessReplicaHealthReportCreatedEvent extends ReplicaEventInner {
    /**
     * Id of report source.
     */
     ...
     * @return the StatelessReplicaHealthReportCreatedEvent object itself.
     */
    public StatelessReplicaHealthReportCreatedEvent withSourceId(String sourceId) {
     ...
     * @return the StatelessReplicaHealthReportCreatedEvent object itself.
     */
    public StatelessReplicaHealthReportCreatedEvent withProperty(String property) {
     ...
     * @return the StatelessReplicaHealthReportCreatedEvent object itself.
     */
    public StatelessReplicaHealthReportCreatedEvent withHealthState(String healthState) {
     ...
     * @return the StatelessReplicaHealthReportCreatedEvent object itself.
     */
    public StatelessReplicaHealthReportCreatedEvent withTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the StatelessReplicaHealthReportCreatedEvent object itself.
     */
    public StatelessReplicaHealthReportCreatedEvent withSequenceNumber(long sequenceNumber) {
     ...
     * @return the StatelessReplicaHealthReportCreatedEvent object itself.
     */
    public StatelessReplicaHealthReportCreatedEvent withDescription(String description) {
     ...
     * @return the StatelessReplicaHealthReportCreatedEvent object itself.
     */
    public StatelessReplicaHealthReportCreatedEvent withRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the StatelessReplicaHealthReportCreatedEvent object itself.
     */
    public StatelessReplicaHealthReportCreatedEvent withSourceUtcTimestamp(DateTime sourceUtcTimestamp) {
