...
import com.microsoft.azure.servicefabric.ApplicationTypeHealthPolicyMapItem;
 ...
 * cluster node.
 */
public class ClusterHealthPolicyInner {
    /**
     ...
     * @return the ClusterHealthPolicyInner object itself.
     */
    public ClusterHealthPolicyInner withConsiderWarningAsError(Boolean considerWarningAsError) {
     ...
     * @return the ClusterHealthPolicyInner object itself.
     */
    public ClusterHealthPolicyInner withMaxPercentUnhealthyNodes(Integer maxPercentUnhealthyNodes) {
     ...
     * @return the ClusterHealthPolicyInner object itself.
     */
    public ClusterHealthPolicyInner withMaxPercentUnhealthyApplications(Integer maxPercentUnhealthyApplications) {
        this.maxPercentUnhealthyApplications = maxPercentUnhealthyApplications;
        return this;
    }

    /**
     * Get the applicationTypeHealthPolicyMap value.
     *
    ...
    /**
     * Set the applicationTypeHealthPolicyMap value.
     *
     * @param applicationTypeHealthPolicyMap the applicationTypeHealthPolicyMap value to set
     * @return the ClusterHealthPolicyInner object itself.
     */
    public ClusterHealthPolicyInner withApplicationTypeHealthPolicyMap(List<ApplicationTypeHealthPolicyMapItem> applicationTypeHealthPolicyMap) {
