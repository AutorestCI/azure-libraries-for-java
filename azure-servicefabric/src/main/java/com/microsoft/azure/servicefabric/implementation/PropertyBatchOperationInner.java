...
public class PropertyBatchOperationInner {
    /**
     ...
     * @return the PropertyBatchOperationInner object itself.
     */
    public PropertyBatchOperationInner withPropertyName(String propertyName) {
