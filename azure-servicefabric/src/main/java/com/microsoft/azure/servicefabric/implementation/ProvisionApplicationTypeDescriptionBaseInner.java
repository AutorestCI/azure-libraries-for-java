...
public class ProvisionApplicationTypeDescriptionBaseInner {
    /**
     ...
     * @return the ProvisionApplicationTypeDescriptionBaseInner object itself.
     */
    public ProvisionApplicationTypeDescriptionBaseInner withAsync(boolean async) {
        this.async = async;
        return this;
    }
