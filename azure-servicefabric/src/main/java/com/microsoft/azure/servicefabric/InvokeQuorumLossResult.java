...
public class InvokeQuorumLossResult {
     ...
     */
    public InvokeQuorumLossResult withErrorCode(Integer errorCode) {
        this.errorCode = errorCode;
        return this;
    }

    /**
     * Get the selectedPartition value.
     *
    ...
    /**
     * Set the selectedPartition value.
     *
     * @param selectedPartition the selectedPartition value to set
     * @return the InvokeQuorumLossResult object itself.
     */
    public InvokeQuorumLossResult withSelectedPartition(SelectedPartition selectedPartition) {
