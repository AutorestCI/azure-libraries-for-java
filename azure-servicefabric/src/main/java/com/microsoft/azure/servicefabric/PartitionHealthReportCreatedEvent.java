...
@JsonTypeName("PartitionHealthReportCreated")
public class PartitionHealthReportCreatedEvent extends PartitionEventInner {
    /**
     * Id of report source.
     */
     ...
     * @return the PartitionHealthReportCreatedEvent object itself.
     */
    public PartitionHealthReportCreatedEvent withSourceId(String sourceId) {
     ...
     * @return the PartitionHealthReportCreatedEvent object itself.
     */
    public PartitionHealthReportCreatedEvent withProperty(String property) {
     ...
     * @return the PartitionHealthReportCreatedEvent object itself.
     */
    public PartitionHealthReportCreatedEvent withHealthState(String healthState) {
     ...
     * @return the PartitionHealthReportCreatedEvent object itself.
     */
    public PartitionHealthReportCreatedEvent withTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the PartitionHealthReportCreatedEvent object itself.
     */
    public PartitionHealthReportCreatedEvent withSequenceNumber(long sequenceNumber) {
     ...
     * @return the PartitionHealthReportCreatedEvent object itself.
     */
    public PartitionHealthReportCreatedEvent withDescription(String description) {
     ...
     * @return the PartitionHealthReportCreatedEvent object itself.
     */
    public PartitionHealthReportCreatedEvent withRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the PartitionHealthReportCreatedEvent object itself.
     */
    public PartitionHealthReportCreatedEvent withSourceUtcTimestamp(DateTime sourceUtcTimestamp) {
