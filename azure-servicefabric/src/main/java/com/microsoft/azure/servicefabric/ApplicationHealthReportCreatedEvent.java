...
@JsonTypeName("ApplicationHealthReportCreated")
public class ApplicationHealthReportCreatedEvent extends ApplicationEventInner {
    /**
     ...
     * @return the ApplicationHealthReportCreatedEvent object itself.
     */
    public ApplicationHealthReportCreatedEvent withApplicationInstanceId(long applicationInstanceId) {
     ...
     * @return the ApplicationHealthReportCreatedEvent object itself.
     */
    public ApplicationHealthReportCreatedEvent withSourceId(String sourceId) {
     ...
     * @return the ApplicationHealthReportCreatedEvent object itself.
     */
    public ApplicationHealthReportCreatedEvent withProperty(String property) {
     ...
     * @return the ApplicationHealthReportCreatedEvent object itself.
     */
    public ApplicationHealthReportCreatedEvent withHealthState(String healthState) {
     ...
     * @return the ApplicationHealthReportCreatedEvent object itself.
     */
    public ApplicationHealthReportCreatedEvent withTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the ApplicationHealthReportCreatedEvent object itself.
     */
    public ApplicationHealthReportCreatedEvent withSequenceNumber(long sequenceNumber) {
     ...
     * @return the ApplicationHealthReportCreatedEvent object itself.
     */
    public ApplicationHealthReportCreatedEvent withDescription(String description) {
     ...
     * @return the ApplicationHealthReportCreatedEvent object itself.
     */
    public ApplicationHealthReportCreatedEvent withRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the ApplicationHealthReportCreatedEvent object itself.
     */
    public ApplicationHealthReportCreatedEvent withSourceUtcTimestamp(DateTime sourceUtcTimestamp) {
