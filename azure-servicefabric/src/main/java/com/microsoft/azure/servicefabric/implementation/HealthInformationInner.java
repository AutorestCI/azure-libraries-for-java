 ...
 * queries.
 */
public class HealthInformationInner {
    /**
     * The source name which identifies the client/watchdog/system component
     * which generated the health information.
     */
     ...
     * @return the HealthInformationInner object itself.
     */
    public HealthInformationInner withSourceId(String sourceId) {
     ...
     * @return the HealthInformationInner object itself.
     */
    public HealthInformationInner withProperty(String property) {
     ...
     * @return the HealthInformationInner object itself.
     */
    public HealthInformationInner withHealthState(HealthState healthState) {
        this.healthState = healthState;
        return this;
    }

    /**
     * Get the timeToLiveInMilliSeconds value.
     *
    ...
    /**
     * Set the timeToLiveInMilliSeconds value.
     *
     * @param timeToLiveInMilliSeconds the timeToLiveInMilliSeconds value to set
     * @return the HealthInformationInner object itself.
     */
    public HealthInformationInner withTimeToLiveInMilliSeconds(Period timeToLiveInMilliSeconds) {
     ...
     * @return the HealthInformationInner object itself.
     */
    public HealthInformationInner withDescription(String description) {
     ...
     * @return the HealthInformationInner object itself.
     */
    public HealthInformationInner withSequenceNumber(String sequenceNumber) {
     ...
     * @return the HealthInformationInner object itself.
     */
    public HealthInformationInner withRemoveWhenExpired(Boolean removeWhenExpired) {
