...
@JsonTypeName("ApplicationUpgradeRollbackComplete")
public class ApplicationUpgradeRollbackCompleteEvent extends ApplicationEventInner {
    /**
     ...
     * @return the ApplicationUpgradeRollbackCompleteEvent object itself.
     */
    public ApplicationUpgradeRollbackCompleteEvent withApplicationTypeName(String applicationTypeName) {
     ...
     * @return the ApplicationUpgradeRollbackCompleteEvent object itself.
     */
    public ApplicationUpgradeRollbackCompleteEvent withApplicationTypeVersion(String applicationTypeVersion) {
     ...
     * @return the ApplicationUpgradeRollbackCompleteEvent object itself.
     */
    public ApplicationUpgradeRollbackCompleteEvent withFailureReason(String failureReason) {
     ...
     * @return the ApplicationUpgradeRollbackCompleteEvent object itself.
     */
    public ApplicationUpgradeRollbackCompleteEvent withOverallUpgradeElapsedTimeInMs(double overallUpgradeElapsedTimeInMs) {
