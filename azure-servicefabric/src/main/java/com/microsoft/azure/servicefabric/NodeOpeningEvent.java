...
@JsonTypeName("NodeOpening")
public class NodeOpeningEvent extends NodeEventInner {
    /**
     * Id of Node instance.
     */
     ...
     * @return the NodeOpeningEvent object itself.
     */
    public NodeOpeningEvent withNodeInstance(long nodeInstance) {
     ...
     * @return the NodeOpeningEvent object itself.
     */
    public NodeOpeningEvent withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
     ...
     * @return the NodeOpeningEvent object itself.
     */
    public NodeOpeningEvent withUpgradeDomain(String upgradeDomain) {
     ...
     * @return the NodeOpeningEvent object itself.
     */
    public NodeOpeningEvent withFaultDomain(String faultDomain) {
     ...
     * @return the NodeOpeningEvent object itself.
     */
    public NodeOpeningEvent withIpAddressOrFQDN(String ipAddressOrFQDN) {
     ...
     * @return the NodeOpeningEvent object itself.
     */
    public NodeOpeningEvent withHostname(String hostname) {
     ...
     * @return the NodeOpeningEvent object itself.
     */
    public NodeOpeningEvent withIsSeedNode(boolean isSeedNode) {
     ...
     * @return the NodeOpeningEvent object itself.
     */
    public NodeOpeningEvent withNodeVersion(String nodeVersion) {
