...
@JsonTypeName("ChaosRemoveReplicaFaultScheduled")
public class ChaosRemoveReplicaFaultScheduledEvent extends ReplicaEventInner {
    /**
     * Id of fault group.
     */
     ...
     * @return the ChaosRemoveReplicaFaultScheduledEvent object itself.
     */
    public ChaosRemoveReplicaFaultScheduledEvent withFaultGroupId(UUID faultGroupId) {
     ...
     * @return the ChaosRemoveReplicaFaultScheduledEvent object itself.
     */
    public ChaosRemoveReplicaFaultScheduledEvent withFaultId(UUID faultId) {
     ...
     * @return the ChaosRemoveReplicaFaultScheduledEvent object itself.
     */
    public ChaosRemoveReplicaFaultScheduledEvent withServiceUri(String serviceUri) {
