...
@JsonTypeName("ChaosRestartCodePackageFaultCompleted")
public class ChaosRestartCodePackageFaultCompletedEvent extends ApplicationEventInner {
    /**
     * Id of fault group.
     */
     ...
     * @return the ChaosRestartCodePackageFaultCompletedEvent object itself.
     */
    public ChaosRestartCodePackageFaultCompletedEvent withFaultGroupId(UUID faultGroupId) {
     ...
     * @return the ChaosRestartCodePackageFaultCompletedEvent object itself.
     */
    public ChaosRestartCodePackageFaultCompletedEvent withFaultId(UUID faultId) {
     ...
     * @return the ChaosRestartCodePackageFaultCompletedEvent object itself.
     */
    public ChaosRestartCodePackageFaultCompletedEvent withNodeName(String nodeName) {
     ...
     * @return the ChaosRestartCodePackageFaultCompletedEvent object itself.
     */
    public ChaosRestartCodePackageFaultCompletedEvent withServiceManifestName(String serviceManifestName) {
     ...
     * @return the ChaosRestartCodePackageFaultCompletedEvent object itself.
     */
    public ChaosRestartCodePackageFaultCompletedEvent withCodePackageName(String codePackageName) {
     ...
     * @return the ChaosRestartCodePackageFaultCompletedEvent object itself.
     */
    public ChaosRestartCodePackageFaultCompletedEvent withServicePackageActivationId(String servicePackageActivationId) {
