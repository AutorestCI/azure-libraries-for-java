 ...
 */
public class PagedReplicaInfoListInner {
    /**
    ...
    private List<ReplicaInfoInner> items;
     ...
     * @return the PagedReplicaInfoListInner object itself.
     */
    public PagedReplicaInfoListInner withContinuationToken(String continuationToken) {
     ...
     */
    public List<ReplicaInfoInner> items() {
        return this.items;
    }
     ...
     * @return the PagedReplicaInfoListInner object itself.
     */
    public PagedReplicaInfoListInner withItems(List<ReplicaInfoInner> items) {
        this.items = items;
        return this;
    }
