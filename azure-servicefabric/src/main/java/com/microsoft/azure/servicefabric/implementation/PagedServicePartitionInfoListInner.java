 ...
 */
public class PagedServicePartitionInfoListInner {
    /**
    ...
    private List<ServicePartitionInfoInner> items;
     ...
     * @return the PagedServicePartitionInfoListInner object itself.
     */
    public PagedServicePartitionInfoListInner withContinuationToken(String continuationToken) {
     ...
     */
    public List<ServicePartitionInfoInner> items() {
        return this.items;
    }
     ...
     * @return the PagedServicePartitionInfoListInner object itself.
     */
    public PagedServicePartitionInfoListInner withItems(List<ServicePartitionInfoInner> items) {
        this.items = items;
        return this;
    }
