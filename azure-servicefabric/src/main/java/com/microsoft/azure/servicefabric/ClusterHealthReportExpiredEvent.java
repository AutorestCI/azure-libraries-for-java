...
public class ClusterHealthReportExpiredEvent extends ClusterEventInner {
    /**
     * Id of report source.
     */
     ...
     */
    public ClusterHealthReportExpiredEvent withSourceId(String sourceId) {
     ...
     * @return the ClusterHealthReportExpiredEvent object itself.
     */
    public ClusterHealthReportExpiredEvent withProperty(String property) {
     ...
     * @return the ClusterHealthReportExpiredEvent object itself.
     */
    public ClusterHealthReportExpiredEvent withHealthState(String healthState) {
     ...
     * @return the ClusterHealthReportExpiredEvent object itself.
     */
    public ClusterHealthReportExpiredEvent withTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the ClusterHealthReportExpiredEvent object itself.
     */
    public ClusterHealthReportExpiredEvent withSequenceNumber(long sequenceNumber) {
     ...
     * @return the ClusterHealthReportExpiredEvent object itself.
     */
    public ClusterHealthReportExpiredEvent withDescription(String description) {
     ...
     * @return the ClusterHealthReportExpiredEvent object itself.
     */
    public ClusterHealthReportExpiredEvent withRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the ClusterHealthReportExpiredEvent object itself.
     */
    public ClusterHealthReportExpiredEvent withSourceUtcTimestamp(DateTime sourceUtcTimestamp) {
