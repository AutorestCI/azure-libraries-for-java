...
import com.microsoft.azure.servicefabric.ServiceTypeHealthPolicy;
import java.util.List;
import com.microsoft.azure.servicefabric.ServiceTypeHealthPolicyMapItem;
 ...
 */
public class ApplicationHealthPolicyInner {
    /**
     ...
     * @return the ApplicationHealthPolicyInner object itself.
     */
    public ApplicationHealthPolicyInner withConsiderWarningAsError(Boolean considerWarningAsError) {
     ...
     * @return the ApplicationHealthPolicyInner object itself.
     */
    public ApplicationHealthPolicyInner withMaxPercentUnhealthyDeployedApplications(Integer maxPercentUnhealthyDeployedApplications) {
     ...
     * @return the ApplicationHealthPolicyInner object itself.
     */
    public ApplicationHealthPolicyInner withDefaultServiceTypeHealthPolicy(ServiceTypeHealthPolicy defaultServiceTypeHealthPolicy) {
     ...
     * @return the ApplicationHealthPolicyInner object itself.
     */
    public ApplicationHealthPolicyInner withServiceTypeHealthPolicyMap(List<ServiceTypeHealthPolicyMapItem> serviceTypeHealthPolicyMap) {
