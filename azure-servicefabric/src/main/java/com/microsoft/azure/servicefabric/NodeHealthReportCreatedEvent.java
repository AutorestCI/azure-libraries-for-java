...
@JsonTypeName("NodeHealthReportCreated")
public class NodeHealthReportCreatedEvent extends NodeEventInner {
    /**
     * Id of Node instance.
     */
     ...
     * @return the NodeHealthReportCreatedEvent object itself.
     */
    public NodeHealthReportCreatedEvent withNodeInstanceId(long nodeInstanceId) {
     ...
     * @return the NodeHealthReportCreatedEvent object itself.
     */
    public NodeHealthReportCreatedEvent withSourceId(String sourceId) {
     ...
     * @return the NodeHealthReportCreatedEvent object itself.
     */
    public NodeHealthReportCreatedEvent withProperty(String property) {
     ...
     * @return the NodeHealthReportCreatedEvent object itself.
     */
    public NodeHealthReportCreatedEvent withHealthState(String healthState) {
     ...
     * @return the NodeHealthReportCreatedEvent object itself.
     */
    public NodeHealthReportCreatedEvent withTimeToLiveMs(long timeToLiveMs) {
     ...
     * @return the NodeHealthReportCreatedEvent object itself.
     */
    public NodeHealthReportCreatedEvent withSequenceNumber(long sequenceNumber) {
     ...
     * @return the NodeHealthReportCreatedEvent object itself.
     */
    public NodeHealthReportCreatedEvent withDescription(String description) {
     ...
     * @return the NodeHealthReportCreatedEvent object itself.
     */
    public NodeHealthReportCreatedEvent withRemoveWhenExpired(boolean removeWhenExpired) {
     ...
     * @return the NodeHealthReportCreatedEvent object itself.
     */
    public NodeHealthReportCreatedEvent withSourceUtcTimestamp(DateTime sourceUtcTimestamp) {
