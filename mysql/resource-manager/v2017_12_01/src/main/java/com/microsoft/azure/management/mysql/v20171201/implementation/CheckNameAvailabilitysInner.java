...
import com.microsoft.azure.management.mysql.v20171201.NameAvailabilityRequest;
...
public class CheckNameAvailabilitysInner {
    ...
    interface CheckNameAvailabilitysService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mysql.v20171201.CheckNameAvailabilitys execute" })
