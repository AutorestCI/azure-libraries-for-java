...
public class ProviderOperationsMetadatasInner {
    ...
    interface ProviderOperationsMetadatasService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.authorization.ProviderOperationsMetadatas get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.authorization.ProviderOperationsMetadatas list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.authorization.ProviderOperationsMetadatas listNext" })
        @GET
