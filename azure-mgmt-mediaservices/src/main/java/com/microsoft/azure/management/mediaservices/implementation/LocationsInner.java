...
public class LocationsInner {
    ...
    interface LocationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.Locations checkNameAvailability" })
        @POST("subscriptions/{subscriptionId}/providers/Microsoft.Media/locations/{locationName}/checkNameAvailability")
        Observable<Response<ResponseBody>> checkNameAvailability(@Path("subscriptionId") String subscriptionId, @Path("locationName") String locationName, @Body CheckNameAvailabilityInputInner parameters, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
     ...
     */
    public EntityNameAvailabilityCheckOutputInner checkNameAvailability(String locationName, CheckNameAvailabilityInputInner parameters) {
     ...
     */
    public ServiceFuture<EntityNameAvailabilityCheckOutputInner> checkNameAvailabilityAsync(String locationName, CheckNameAvailabilityInputInner parameters, final ServiceCallback<EntityNameAvailabilityCheckOutputInner> serviceCallback) {
     ...
     */
    public Observable<EntityNameAvailabilityCheckOutputInner> checkNameAvailabilityAsync(String locationName, CheckNameAvailabilityInputInner parameters) {
     ...
     * @return the observable to the EntityNameAvailabilityCheckOutputInner object
     */
    public Observable<ServiceResponse<EntityNameAvailabilityCheckOutputInner>> checkNameAvailabilityWithServiceResponseAsync(String locationName, CheckNameAvailabilityInputInner parameters) {
