...
import com.microsoft.azure.management.mediaservices.CheckNameAvailabilityInput;
import com.microsoft.azure.management.mediaservices.KeyType;
import com.microsoft.azure.management.mediaservices.RegenerateKeyInput;
import com.microsoft.azure.management.mediaservices.SyncStorageKeysInput;
...
public class MediaServicesInner implements InnerSupportsGet<MediaServiceInner>, InnerSupportsDelete<Void> {
    ...
    interface MediaServicesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.MediaServices checkNameAvailability" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.MediaServices listByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.MediaServices getByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.MediaServices create" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.MediaServices delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.MediaServices update" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.MediaServices regenerateKey" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.MediaServices listKeys" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.MediaServices syncStorageKeys" })
            ...
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<List<MediaServiceInner>>>>() {
                ...
                public Observable<ServiceResponse<List<MediaServiceInner>>> call(Response<ResponseBody> response) {
                    try {
                        ...
                        ServiceResponse<List<MediaServiceInner>> clientResponse = new ServiceResponse<List<MediaServiceInner>>(result.body().items(), result.response());
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
