...
public class OriginsInner {
     ...
     */
    public ServiceFuture<List<OriginInner>> listByEndpointAsync(final String profileName, final String endpointName, final ListOperationCallback<OriginInner> serviceCallback) {
    ...
    public OriginInner get(String profileName, String endpointName, String originName) {
        return getWithServiceResponseAsync(profileName, endpointName, originName).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<OriginInner> getAsync(String profileName, String endpointName, String originName, final ServiceCallback<OriginInner> serviceCallback) {
        return ServiceFuture.fromResponse(getWithServiceResponseAsync(profileName, endpointName, originName), serviceCallback);
    }
    ...
    public OriginInner update(String profileName, String endpointName, String originName, OriginUpdateParametersInner originUpdateProperties) {
        return updateWithServiceResponseAsync(profileName, endpointName, originName, originUpdateProperties).toBlocking().last().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<OriginInner> updateAsync(String profileName, String endpointName, String originName, OriginUpdateParametersInner originUpdateProperties, final ServiceCallback<OriginInner> serviceCallback) {
        return ServiceFuture.fromResponse(updateWithServiceResponseAsync(profileName, endpointName, originName, originUpdateProperties), serviceCallback);
    }
    ...
    public OriginInner beginUpdate(String profileName, String endpointName, String originName, OriginUpdateParametersInner originUpdateProperties) {
        return beginUpdateWithServiceResponseAsync(profileName, endpointName, originName, originUpdateProperties).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<OriginInner> beginUpdateAsync(String profileName, String endpointName, String originName, OriginUpdateParametersInner originUpdateProperties, final ServiceCallback<OriginInner> serviceCallback) {
        return ServiceFuture.fromResponse(beginUpdateWithServiceResponseAsync(profileName, endpointName, originName, originUpdateProperties), serviceCallback);
    }
