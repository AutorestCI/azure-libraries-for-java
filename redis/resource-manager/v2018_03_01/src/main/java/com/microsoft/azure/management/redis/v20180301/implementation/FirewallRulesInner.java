...
import com.microsoft.azure.management.redis.v20180301.RedisFirewallRuleCreateParameters;
...
public class FirewallRulesInner {
    ...
    interface FirewallRulesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.redis.v20180301.FirewallRules listByRedisResource" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.redis.v20180301.FirewallRules createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.redis.v20180301.FirewallRules get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.redis.v20180301.FirewallRules delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.redis.v20180301.FirewallRules listByRedisResourceNext" })
        @GET
