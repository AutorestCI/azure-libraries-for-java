...
import com.microsoft.azure.management.redis.v20171001.ScheduleEntry;
...
public class PatchSchedulesInner implements InnerSupportsDelete<Void> {
    ...
    interface PatchSchedulesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.redis.v20171001.PatchSchedules listByRedisResource" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.redis.v20171001.PatchSchedules createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.redis.v20171001.PatchSchedules delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.redis.v20171001.PatchSchedules get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.redis.v20171001.PatchSchedules listByRedisResourceNext" })
        @GET
