...
import com.microsoft.azure.management.cognitiveservices.v20170418.CognitiveServicesAccountCreateParameters;
import com.microsoft.azure.management.cognitiveservices.v20170418.CognitiveServicesAccountUpdateParameters;
import com.microsoft.azure.management.cognitiveservices.v20170418.ErrorException;
import com.microsoft.azure.management.cognitiveservices.v20170418.KeyName;
import com.microsoft.azure.management.cognitiveservices.v20170418.RegenerateKeyParameters;
import com.microsoft.azure.management.cognitiveservices.v20170418.Sku;
...
public class AccountsInner implements InnerSupportsGet<CognitiveServicesAccountInner>, InnerSupportsDelete<Void>, InnerSupportsListing<CognitiveServicesAccountInner> {
    ...
    interface AccountsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20170418.Accounts create" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20170418.Accounts update" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20170418.Accounts delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20170418.Accounts getByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20170418.Accounts listByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20170418.Accounts list" })
        @GET("subscriptions/{subscriptionId}/providers/Microsoft.CognitiveServices/accounts")
        Observable<Response<ResponseBody>> list(@Path("subscriptionId") String subscriptionId, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20170418.Accounts listKeys" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20170418.Accounts regenerateKey" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20170418.Accounts listSkus" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20170418.Accounts getUsages" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20170418.Accounts listByResourceGroupNext" })
        @GET
        Observable<Response<ResponseBody>> listByResourceGroupNext(@Url String nextUrl, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20170418.Accounts listNext" })
        @GET
