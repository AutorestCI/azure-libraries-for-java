...
import com.microsoft.azure.management.cognitiveservices.v20170418.CheckSkuAvailabilityParameter;
import com.microsoft.azure.management.cognitiveservices.v20170418.Kind;
import com.microsoft.azure.management.cognitiveservices.v20170418.SkuName;
...
public class CheckSkuAvailabilitysInner {
    ...
    interface CheckSkuAvailabilitysService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20170418.CheckSkuAvailabilitys list" })
