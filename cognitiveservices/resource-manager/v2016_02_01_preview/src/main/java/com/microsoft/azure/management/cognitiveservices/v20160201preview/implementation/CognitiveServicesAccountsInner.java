...
import com.microsoft.azure.management.cognitiveservices.v20160201preview.CognitiveServicesAccountCreateParameters;
import com.microsoft.azure.management.cognitiveservices.v20160201preview.CognitiveServicesAccountUpdateParameters;
import com.microsoft.azure.management.cognitiveservices.v20160201preview.ErrorException;
import com.microsoft.azure.management.cognitiveservices.v20160201preview.KeyName;
import com.microsoft.azure.management.cognitiveservices.v20160201preview.RegenerateKeyParameters;
import com.microsoft.azure.management.cognitiveservices.v20160201preview.Sku;
...
public class CognitiveServicesAccountsInner implements InnerSupportsGet<CognitiveServicesAccountInner>, InnerSupportsDelete<Void>, InnerSupportsListing<CognitiveServicesAccountInner> {
    ...
    interface CognitiveServicesAccountsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20160201preview.CognitiveServicesAccounts create" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20160201preview.CognitiveServicesAccounts update" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20160201preview.CognitiveServicesAccounts delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20160201preview.CognitiveServicesAccounts getByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20160201preview.CognitiveServicesAccounts listByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20160201preview.CognitiveServicesAccounts list" })
        @GET("subscriptions/{subscriptionId}/providers/Microsoft.CognitiveServices/accounts")
        Observable<Response<ResponseBody>> list(@Path("subscriptionId") String subscriptionId, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20160201preview.CognitiveServicesAccounts listKeys" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20160201preview.CognitiveServicesAccounts regenerateKey" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.cognitiveservices.v20160201preview.CognitiveServicesAccounts listSkus" })
