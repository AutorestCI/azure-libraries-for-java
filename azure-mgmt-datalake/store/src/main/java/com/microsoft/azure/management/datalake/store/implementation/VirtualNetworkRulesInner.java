...
import com.microsoft.azure.management.datalake.store.CreateOrUpdateVirtualNetworkRuleParameters;
import com.microsoft.azure.management.datalake.store.UpdateVirtualNetworkRuleParameters;
...
public class VirtualNetworkRulesInner {
    ...
    interface VirtualNetworkRulesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datalake.store.VirtualNetworkRules listByAccount" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datalake.store.VirtualNetworkRules createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datalake.store.VirtualNetworkRules get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datalake.store.VirtualNetworkRules update" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datalake.store.VirtualNetworkRules delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datalake.store.VirtualNetworkRules listByAccountNext" })
        @GET
