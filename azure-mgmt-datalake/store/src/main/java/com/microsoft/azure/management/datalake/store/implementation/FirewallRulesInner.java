...
import com.microsoft.azure.management.datalake.store.CreateOrUpdateFirewallRuleParameters;
import com.microsoft.azure.management.datalake.store.UpdateFirewallRuleParameters;
...
public class FirewallRulesInner {
     ...
     */
    public FirewallRulesInner(Retrofit retrofit, DataLakeStoreAccountManagementClientImpl client) {
    ...
    interface FirewallRulesService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datalake.store.FirewallRules update" })
    ...
    ServiceResponse<PageImpl<FirewallRuleInner>> * @param accountName The name of the Data Lake Store account.
     * @throws IllegalArgumentException thrown if parameters fail the validation
