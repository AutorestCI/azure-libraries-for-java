...
import com.microsoft.azure.management.datalake.store.CheckNameAvailabilityParameters;
import com.microsoft.azure.management.datalake.store.CreateDataLakeStoreAccountParameters;
import com.microsoft.azure.management.datalake.store.UpdateDataLakeStoreAccountParameters;
...
public class AccountsInner implements InnerSupportsGet<DataLakeStoreAccountInner>, InnerSupportsDelete<Void>, InnerSupportsListing<DataLakeStoreAccountBasicInner> {
    ...
    interface AccountsService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.datalake.store.Accounts getByResourceGroup" })
