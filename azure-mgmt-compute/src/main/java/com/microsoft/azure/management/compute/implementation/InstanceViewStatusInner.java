 ...
 */
public class InstanceViewStatusInner {
    /**
     * The status code.
     */
     ...
     */
    public InstanceViewStatusInner withCode(String code) {
        this.code = code;
        return this;
    }
     ...
     * @return the InstanceViewStatusInner object itself.
     */
    public InstanceViewStatusInner withLevel(StatusLevelTypes level) {
        this.level = level;
        return this;
    }
     ...
     * @return the InstanceViewStatusInner object itself.
     */
    public InstanceViewStatusInner withDisplayStatus(String displayStatus) {
     ...
     * @return the InstanceViewStatusInner object itself.
     */
    public InstanceViewStatusInner withMessage(String message) {
     ...
     * @return the InstanceViewStatusInner object itself.
     */
    public InstanceViewStatusInner withTime(DateTime time) {
        this.time = time;
        return this;
    }
