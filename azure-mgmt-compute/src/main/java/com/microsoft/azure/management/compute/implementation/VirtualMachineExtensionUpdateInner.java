 ...
 */
@JsonFlatten
public class VirtualMachineExtensionUpdateInner extends UpdateResource {
    /**
     ...
     * @return the VirtualMachineExtensionUpdateInner object itself.
     */
    public VirtualMachineExtensionUpdateInner withForceUpdateTag(String forceUpdateTag) {
     ...
     * @return the VirtualMachineExtensionUpdateInner object itself.
     */
    public VirtualMachineExtensionUpdateInner withPublisher(String publisher) {
     ...
     * @return the VirtualMachineExtensionUpdateInner object itself.
     */
    public VirtualMachineExtensionUpdateInner withType(String type) {
        this.type = type;
        return this;
    }
     ...
     * @return the VirtualMachineExtensionUpdateInner object itself.
     */
    public VirtualMachineExtensionUpdateInner withTypeHandlerVersion(String typeHandlerVersion) {
     ...
     * @return the VirtualMachineExtensionUpdateInner object itself.
     */
    public VirtualMachineExtensionUpdateInner withAutoUpgradeMinorVersion(Boolean autoUpgradeMinorVersion) {
     ...
     * @return the VirtualMachineExtensionUpdateInner object itself.
     */
    public VirtualMachineExtensionUpdateInner withSettings(Object settings) {
     ...
     * @return the VirtualMachineExtensionUpdateInner object itself.
     */
    public VirtualMachineExtensionUpdateInner withProtectedSettings(Object protectedSettings) {
