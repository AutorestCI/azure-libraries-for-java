 ...
 */
@JsonFlatten
public class VirtualMachineScaleSetUpdateIPConfigurationInner extends SubResource {
    /**
     ...
     * @return the VirtualMachineScaleSetUpdateIPConfigurationInner object itself.
     */
    public VirtualMachineScaleSetUpdateIPConfigurationInner withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the VirtualMachineScaleSetUpdateIPConfigurationInner object itself.
     */
    public VirtualMachineScaleSetUpdateIPConfigurationInner withSubnet(ApiEntityReference subnet) {
        this.subnet = subnet;
        return this;
    }
     ...
     * @return the VirtualMachineScaleSetUpdateIPConfigurationInner object itself.
     */
    public VirtualMachineScaleSetUpdateIPConfigurationInner withPrimary(Boolean primary) {
     ...
     * @return the VirtualMachineScaleSetUpdateIPConfigurationInner object itself.
     */
    public VirtualMachineScaleSetUpdateIPConfigurationInner withPublicIPAddressConfiguration(VirtualMachineScaleSetUpdatePublicIPAddressConfiguration publicIPAddressConfiguration) {
     ...
     * @return the VirtualMachineScaleSetUpdateIPConfigurationInner object itself.
     */
    public VirtualMachineScaleSetUpdateIPConfigurationInner withPrivateIPAddressVersion(IPVersion privateIPAddressVersion) {
     ...
     * @return the VirtualMachineScaleSetUpdateIPConfigurationInner object itself.
     */
    public VirtualMachineScaleSetUpdateIPConfigurationInner withApplicationGatewayBackendAddressPools(List<SubResource> applicationGatewayBackendAddressPools) {
     ...
     * @return the VirtualMachineScaleSetUpdateIPConfigurationInner object itself.
     */
    public VirtualMachineScaleSetUpdateIPConfigurationInner withLoadBalancerBackendAddressPools(List<SubResource> loadBalancerBackendAddressPools) {
     ...
     * @return the VirtualMachineScaleSetUpdateIPConfigurationInner object itself.
     */
    public VirtualMachineScaleSetUpdateIPConfigurationInner withLoadBalancerInboundNatPools(List<SubResource> loadBalancerInboundNatPools) {
