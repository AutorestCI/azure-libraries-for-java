...
public class AvailabilitySetUpdateInner extends UpdateResource {
     ...
     * @return the AvailabilitySetUpdateInner object itself.
     */
    public AvailabilitySetUpdateInner withPlatformUpdateDomainCount(Integer platformUpdateDomainCount) {
     ...
     * @return the AvailabilitySetUpdateInner object itself.
     */
    public AvailabilitySetUpdateInner withPlatformFaultDomainCount(Integer platformFaultDomainCount) {
     ...
     * @return the AvailabilitySetUpdateInner object itself.
     */
    public AvailabilitySetUpdateInner withVirtualMachines(List<SubResource> virtualMachines) {
     ...
     * @return the AvailabilitySetUpdateInner object itself.
     */
    public AvailabilitySetUpdateInner withSku(Sku sku) {
        this.sku = sku;
        return this;
    }
