 ...
 */
public class StorageSyncServiceByResourceGroupGetListHeaders {
    /**
     * request id.
     */
     ...
     * @return the StorageSyncServiceByResourceGroupGetListHeaders object itself.
     */
    public StorageSyncServiceByResourceGroupGetListHeaders withXMsRequestId(String xMsRequestId) {
     ...
     * @return the StorageSyncServiceByResourceGroupGetListHeaders object itself.
     */
    public StorageSyncServiceByResourceGroupGetListHeaders withXMsCorrelationRequestId(String xMsCorrelationRequestId) {
