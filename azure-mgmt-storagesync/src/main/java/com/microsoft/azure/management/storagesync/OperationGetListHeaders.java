 ...
 */
public class OperationGetListHeaders {
    /**
     * request id.
     */
     ...
     * @return the OperationGetListHeaders object itself.
     */
    public OperationGetListHeaders withXMsRequestId(String xMsRequestId) {
     ...
     * @return the OperationGetListHeaders object itself.
     */
    public OperationGetListHeaders withXMsCorrelationRequestId(String xMsCorrelationRequestId) {
