...
/**
 * Defines headers for RestoreHeatbeat operation.
 */
public class CloudEndpointsRestoreHeatbeatHeaders {
    /**
     * request id.
     */
     ...
     * @return the CloudEndpointsRestoreHeatbeatHeaders object itself.
     */
    public CloudEndpointsRestoreHeatbeatHeaders withXMsRequestId(String xMsRequestId) {
     ...
     * @return the CloudEndpointsRestoreHeatbeatHeaders object itself.
     */
    public CloudEndpointsRestoreHeatbeatHeaders withXMsCorrelationRequestId(String xMsCorrelationRequestId) {
