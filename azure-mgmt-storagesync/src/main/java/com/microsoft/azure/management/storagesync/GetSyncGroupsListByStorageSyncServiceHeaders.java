 ...
 */
public class GetSyncGroupsListByStorageSyncServiceHeaders {
    /**
     * request id.
     */
     ...
     * @return the GetSyncGroupsListByStorageSyncServiceHeaders object itself.
     */
    public GetSyncGroupsListByStorageSyncServiceHeaders withXMsRequestId(String xMsRequestId) {
     ...
     * @return the GetSyncGroupsListByStorageSyncServiceHeaders object itself.
     */
    public GetSyncGroupsListByStorageSyncServiceHeaders withXMsCorrelationRequestId(String xMsCorrelationRequestId) {
