 ...
 */
public class RegisteredServersGetListByStorageSyncServiceHeaders {
    /**
     * request id.
     */
     ...
     * @return the RegisteredServersGetListByStorageSyncServiceHeaders object itself.
     */
    public RegisteredServersGetListByStorageSyncServiceHeaders withXMsRequestId(String xMsRequestId) {
     ...
     * @return the RegisteredServersGetListByStorageSyncServiceHeaders object itself.
     */
    public RegisteredServersGetListByStorageSyncServiceHeaders withXMsCorrelationRequestId(String xMsCorrelationRequestId) {
