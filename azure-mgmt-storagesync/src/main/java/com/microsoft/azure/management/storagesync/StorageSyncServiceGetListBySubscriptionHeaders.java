 ...
 */
public class StorageSyncServiceGetListBySubscriptionHeaders {
    /**
     * request id.
     */
     ...
     * @return the StorageSyncServiceGetListBySubscriptionHeaders object itself.
     */
    public StorageSyncServiceGetListBySubscriptionHeaders withXMsRequestId(String xMsRequestId) {
     ...
     * @return the StorageSyncServiceGetListBySubscriptionHeaders object itself.
     */
    public StorageSyncServiceGetListBySubscriptionHeaders withXMsCorrelationRequestId(String xMsCorrelationRequestId) {
