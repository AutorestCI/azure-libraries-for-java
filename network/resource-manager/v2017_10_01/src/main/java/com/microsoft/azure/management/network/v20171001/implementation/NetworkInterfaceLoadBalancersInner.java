...
public class NetworkInterfaceLoadBalancersInner {
    ...
    interface NetworkInterfaceLoadBalancersService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v20171001.NetworkInterfaceLoadBalancers list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v20171001.NetworkInterfaceLoadBalancers listNext" })
        @GET
