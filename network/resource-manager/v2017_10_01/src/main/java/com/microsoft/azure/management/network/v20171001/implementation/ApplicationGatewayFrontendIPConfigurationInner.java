...
import com.microsoft.azure.management.network.v20171001.IPAllocationMethod;
...
public class ApplicationGatewayFrontendIPConfigurationInner extends SubResource {
     ...
     */
    public ApplicationGatewayFrontendIPConfigurationInner withPrivateIPAddress(String privateIPAddress) {
     ...
     * @return the ApplicationGatewayFrontendIPConfigurationInner object itself.
     */
    public ApplicationGatewayFrontendIPConfigurationInner withSubnet(SubResource subnet) {
        this.subnet = subnet;
        return this;
    }
     ...
     * @return the ApplicationGatewayFrontendIPConfigurationInner object itself.
     */
    public ApplicationGatewayFrontendIPConfigurationInner withProvisioningState(String provisioningState) {
     ...
     * @return the ApplicationGatewayFrontendIPConfigurationInner object itself.
     */
    public ApplicationGatewayFrontendIPConfigurationInner withName(String name) {
        this.name = name;
        return this;
    }
