...
public class LoadBalancerLoadBalancingRulesInner {
    ...
    interface LoadBalancerLoadBalancingRulesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v20180501.LoadBalancerLoadBalancingRules list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v20180501.LoadBalancerLoadBalancingRules get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v20180501.LoadBalancerLoadBalancingRules listNext" })
        @GET
