...
public class LoadBalancerFrontendIPConfigurationsInner {
    ...
    interface LoadBalancerFrontendIPConfigurationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v20180501.LoadBalancerFrontendIPConfigurations list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v20180501.LoadBalancerFrontendIPConfigurations get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v20180501.LoadBalancerFrontendIPConfigurations listNext" })
        @GET
