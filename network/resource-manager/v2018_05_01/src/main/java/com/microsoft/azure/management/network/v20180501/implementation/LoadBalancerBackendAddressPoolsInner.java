...
public class LoadBalancerBackendAddressPoolsInner {
    ...
    interface LoadBalancerBackendAddressPoolsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v20180501.LoadBalancerBackendAddressPools list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v20180501.LoadBalancerBackendAddressPools get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v20180501.LoadBalancerBackendAddressPools listNext" })
        @GET
