...
public class NetworkInterfaceIPConfigurationsInner {
    ...
    interface NetworkInterfaceIPConfigurationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v20180501.NetworkInterfaceIPConfigurations list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v20180501.NetworkInterfaceIPConfigurations get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v20180501.NetworkInterfaceIPConfigurations listNext" })
        @GET
