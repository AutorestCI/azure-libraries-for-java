...
public class BgpServiceCommunitiesInner {
    ...
    interface BgpServiceCommunitiesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v20180501.BgpServiceCommunities list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.network.v20180501.BgpServiceCommunities listNext" })
        @GET
