 ...
 * in Gateways.
 */
public class GatewaysInner implements InnerSupportsGet<GatewayResourceInner>, InnerSupportsDelete<Void>, InnerSupportsListing<GatewayResourceInner> {
    ...
    interface GatewaysService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.servermanagement.Gateways listByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.servermanagement.Gateways listByResourceGroupNext" })
        @GET
     ...
     * @return the PagedList&lt;GatewayResourceInner&gt; object if successful.
     */
    public PagedList<GatewayResourceInner> listByResourceGroup(final String resourceGroupName) {
        ServiceResponse<Page<GatewayResourceInner>> response = listByResourceGroupSinglePageAsync(resourceGroupName).toBlocking().single();
        return new PagedList<GatewayResourceInner>(response.body()) {
            @Override
            public Page<GatewayResourceInner> nextPage(String nextPageLink) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<GatewayResourceInner>> listByResourceGroupAsync(final String resourceGroupName, final ListOperationCallback<GatewayResourceInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
     ...
     * @return the observable to the PagedList&lt;GatewayResourceInner&gt; object
     */
    public Observable<Page<GatewayResourceInner>> listByResourceGroupAsync(final String resourceGroupName) {
     ...
     * @return the observable to the PagedList&lt;GatewayResourceInner&gt; object
     */
    public Observable<ServiceResponse<Page<GatewayResourceInner>>> listByResourceGroupWithServiceResponseAsync(final String resourceGroupName) {
     ...
     * @return the PagedList&lt;GatewayResourceInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<GatewayResourceInner>>> listByResourceGroupSinglePageAsync(final String resourceGroupName) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
        ...
        return service.listByResourceGroup(this.client.subscriptionId(), resourceGroupName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<GatewayResourceInner>>>>() {
                ...
                public Observable<ServiceResponse<Page<GatewayResourceInner>>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<PageImpl<GatewayResourceInner>> result = listByResourceGroupDelegate(response);
                        return Observable.just(new ServiceResponse<Page<GatewayResourceInner>>(result.body(), result.response()));
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<PageImpl<GatewayResourceInner>> listByResourceGroupDelegate(Response<ResponseBody> response) throws ErrorException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<GatewayResourceInner>, ErrorException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl<GatewayResourceInner>>() { }.getType())
                .registerError(ErrorException.class)
                .build(response);
     ...
     * @return the PagedList&lt;GatewayResourceInner&gt; object if successful.
     */
    public PagedList<GatewayResourceInner> listByResourceGroupNext(final String nextPageLink) {
        ServiceResponse<Page<GatewayResourceInner>> response = listByResourceGroupNextSinglePageAsync(nextPageLink).toBlocking().single();
        return new PagedList<GatewayResourceInner>(response.body()) {
            @Override
            public Page<GatewayResourceInner> nextPage(String nextPageLink) {
                return listByResourceGroupNextSinglePageAsync(nextPageLink).toBlocking().single().body();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<GatewayResourceInner>> listByResourceGroupNextAsync(final String nextPageLink, final ServiceFuture<List<GatewayResourceInner>> serviceFuture, final ListOperationCallback<GatewayResourceInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
     ...
     * @return the observable to the PagedList&lt;GatewayResourceInner&gt; object
     */
    public Observable<Page<GatewayResourceInner>> listByResourceGroupNextAsync(final String nextPageLink) {
     ...
     * @return the observable to the PagedList&lt;GatewayResourceInner&gt; object
     */
    public Observable<ServiceResponse<Page<GatewayResourceInner>>> listByResourceGroupNextWithServiceResponseAsync(final String nextPageLink) {
        return listByResourceGroupNextSinglePageAsync(nextPageLink)
            .concatMap(new Func1<ServiceResponse<Page<GatewayResourceInner>>, Observable<ServiceResponse<Page<GatewayResourceInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<GatewayResourceInner>>> call(ServiceResponse<Page<GatewayResourceInner>> page) {
     ...
     * @return the PagedList&lt;GatewayResourceInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<GatewayResourceInner>>> listByResourceGroupNextSinglePageAsync(final String nextPageLink) {
        if (nextPageLink == null) {
            throw new IllegalArgumentException("Parameter nextPageLink is required and cannot be null.");
        }
        String nextUrl = String.format("%s", nextPageLink);
        return service.listByResourceGroupNext(nextUrl, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<GatewayResourceInner>>>>() {
                ...
                public Observable<ServiceResponse<Page<GatewayResourceInner>>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<PageImpl<GatewayResourceInner>> result = listByResourceGroupNextDelegate(response);
                        return Observable.just(new ServiceResponse<Page<GatewayResourceInner>>(result.body(), result.response()));
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<PageImpl<GatewayResourceInner>> listByResourceGroupNextDelegate(Response<ResponseBody> response) throws ErrorException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<GatewayResourceInner>, ErrorException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl<GatewayResourceInner>>() { }.getType())
                .registerError(ErrorException.class)
                .build(response);
