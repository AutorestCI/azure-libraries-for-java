 ...
 * in Nodes.
 */
public class NodesInner implements InnerSupportsGet<NodeResourceInner>, InnerSupportsDelete<Void>, InnerSupportsListing<NodeResourceInner> {
    ...
    interface NodesService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.servermanagement.Nodes listByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.servermanagement.Nodes listByResourceGroupNext" })
        @GET
     ...
     * @return the PagedList&lt;NodeResourceInner&gt; object if successful.
     */
    public PagedList<NodeResourceInner> listByResourceGroup(final String resourceGroupName) {
        ServiceResponse<Page<NodeResourceInner>> response = listByResourceGroupSinglePageAsync(resourceGroupName).toBlocking().single();
        return new PagedList<NodeResourceInner>(response.body()) {
            @Override
            public Page<NodeResourceInner> nextPage(String nextPageLink) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<NodeResourceInner>> listByResourceGroupAsync(final String resourceGroupName, final ListOperationCallback<NodeResourceInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
     ...
     * @return the observable to the PagedList&lt;NodeResourceInner&gt; object
     */
    public Observable<Page<NodeResourceInner>> listByResourceGroupAsync(final String resourceGroupName) {
     ...
     * @return the observable to the PagedList&lt;NodeResourceInner&gt; object
     */
    public Observable<ServiceResponse<Page<NodeResourceInner>>> listByResourceGroupWithServiceResponseAsync(final String resourceGroupName) {
     ...
     * @return the PagedList&lt;NodeResourceInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<NodeResourceInner>>> listByResourceGroupSinglePageAsync(final String resourceGroupName) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
        ...
        return service.listByResourceGroup(this.client.subscriptionId(), resourceGroupName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<NodeResourceInner>>>>() {
                ...
                public Observable<ServiceResponse<Page<NodeResourceInner>>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<PageImpl<NodeResourceInner>> result = listByResourceGroupDelegate(response);
                        return Observable.just(new ServiceResponse<Page<NodeResourceInner>>(result.body(), result.response()));
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<PageImpl<NodeResourceInner>> listByResourceGroupDelegate(Response<ResponseBody> response) throws ErrorException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<NodeResourceInner>, ErrorException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl<NodeResourceInner>>() { }.getType())
                .registerError(ErrorException.class)
                .build(response);
     ...
     * @return the PagedList&lt;NodeResourceInner&gt; object if successful.
     */
    public PagedList<NodeResourceInner> listByResourceGroupNext(final String nextPageLink) {
        ServiceResponse<Page<NodeResourceInner>> response = listByResourceGroupNextSinglePageAsync(nextPageLink).toBlocking().single();
        return new PagedList<NodeResourceInner>(response.body()) {
            @Override
            public Page<NodeResourceInner> nextPage(String nextPageLink) {
                return listByResourceGroupNextSinglePageAsync(nextPageLink).toBlocking().single().body();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<NodeResourceInner>> listByResourceGroupNextAsync(final String nextPageLink, final ServiceFuture<List<NodeResourceInner>> serviceFuture, final ListOperationCallback<NodeResourceInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
     ...
     * @return the observable to the PagedList&lt;NodeResourceInner&gt; object
     */
    public Observable<Page<NodeResourceInner>> listByResourceGroupNextAsync(final String nextPageLink) {
     ...
     * @return the observable to the PagedList&lt;NodeResourceInner&gt; object
     */
    public Observable<ServiceResponse<Page<NodeResourceInner>>> listByResourceGroupNextWithServiceResponseAsync(final String nextPageLink) {
        return listByResourceGroupNextSinglePageAsync(nextPageLink)
            .concatMap(new Func1<ServiceResponse<Page<NodeResourceInner>>, Observable<ServiceResponse<Page<NodeResourceInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<NodeResourceInner>>> call(ServiceResponse<Page<NodeResourceInner>> page) {
     ...
     * @return the PagedList&lt;NodeResourceInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<NodeResourceInner>>> listByResourceGroupNextSinglePageAsync(final String nextPageLink) {
        if (nextPageLink == null) {
            throw new IllegalArgumentException("Parameter nextPageLink is required and cannot be null.");
        }
        String nextUrl = String.format("%s", nextPageLink);
        return service.listByResourceGroupNext(nextUrl, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<NodeResourceInner>>>>() {
                ...
                public Observable<ServiceResponse<Page<NodeResourceInner>>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<PageImpl<NodeResourceInner>> result = listByResourceGroupNextDelegate(response);
                        return Observable.just(new ServiceResponse<Page<NodeResourceInner>>(result.body(), result.response()));
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<PageImpl<NodeResourceInner>> listByResourceGroupNextDelegate(Response<ResponseBody> response) throws ErrorException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<NodeResourceInner>, ErrorException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl<NodeResourceInner>>() { }.getType())
                .registerError(ErrorException.class)
                .build(response);
