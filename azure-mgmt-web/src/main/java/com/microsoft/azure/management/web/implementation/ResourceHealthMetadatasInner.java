...
public class ResourceHealthMetadatasInner implements InnerSupportsListing<ResourceHealthMetadataInner> {
    ...
    interface ResourceHealthMetadatasService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.ResourceHealthMetadatas list" })
        @GET("subscriptions/{subscriptionId}/providers/Microsoft.Web/resourceHealthMetadata")
        Observable<Response<ResponseBody>> list(@Path("subscriptionId") String subscriptionId, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.ResourceHealthMetadatas listByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.ResourceHealthMetadatas listBySite" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.ResourceHealthMetadatas getBySite" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.ResourceHealthMetadatas listBySiteSlot" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.ResourceHealthMetadatas getBySiteSlot" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.ResourceHealthMetadatas listNext" })
        @GET
        Observable<Response<ResponseBody>> listNext(@Url String nextUrl, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.ResourceHealthMetadatas listByResourceGroupNext" })
        @GET
        Observable<Response<ResponseBody>> listByResourceGroupNext(@Url String nextUrl, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.web.ResourceHealthMetadatas listBySiteNext" })
        @GET
    ...
    public Observable<ServiceResponse<Page<ResourceHealthMetadataInner>>> listBySiteSinglePageAsync(final String resourceGroupName, final String name) {
        ...
        final String apiVersion = "2016-03-01";
        return service.listBySite(resourceGroupName, name, this.client.subscriptionId(), apiVersion, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<ResourceHealthMetadataInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<ResourceHealthMetadataInner>>> call(Response<ResponseBody> response) {
                    try {
    ...
    public Observable<ServiceResponse<ResourceHealthMetadataInner>> getBySiteWithServiceResponseAsync(String resourceGroupName, String name) {
        ...
        final String apiVersion = "2016-03-01";
        return service.getBySite(resourceGroupName, name, this.client.subscriptionId(), apiVersion, this.client.acceptLanguage(), this.client.userAgent())
    ...
    public Observable<ServiceResponse<Page<ResourceHealthMetadataInner>>> listBySiteSlotSinglePageAsync(final String resourceGroupName, final String name, final String slot) {
        ...
        final String apiVersion = "2016-03-01";
        return service.listBySiteSlot(resourceGroupName, name, slot, this.client.subscriptionId(), apiVersion, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<ResourceHealthMetadataInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<ResourceHealthMetadataInner>>> call(Response<ResponseBody> response) {
                    try {
    ...
    public Observable<ServiceResponse<ResourceHealthMetadataInner>> getBySiteSlotWithServiceResponseAsync(String resourceGroupName, String name, String slot) {
        ...
        final String apiVersion = "2016-03-01";
        return service.getBySiteSlot(resourceGroupName, name, slot, this.client.subscriptionId(), apiVersion, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<ResourceHealthMetadataInner>>>() {
                @Override
                public Observable<ServiceResponse<ResourceHealthMetadataInner>> call(Response<ResponseBody> response) {
                    try {
