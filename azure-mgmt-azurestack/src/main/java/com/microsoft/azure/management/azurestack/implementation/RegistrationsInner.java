...
public class RegistrationsInner implements InnerSupportsGet<RegistrationInner>, InnerSupportsDelete<Void> {
    ...
    interface RegistrationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.azurestack.Registrations listByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.azurestack.Registrations getByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.azurestack.Registrations delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.azurestack.Registrations createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.azurestack.Registrations getActivationKey" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.azurestack.Registrations listByResourceGroupNext" })
        @GET
     ...
     * @return the RegistrationInner object if successful.
     */
    public RegistrationInner createOrUpdate(String resourceGroup, String registrationName, RegistrationParameterInner token) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<RegistrationInner> createOrUpdateAsync(String resourceGroup, String registrationName, RegistrationParameterInner token, final ServiceCallback<RegistrationInner> serviceCallback) {
     ...
     * @return the observable to the RegistrationInner object
     */
    public Observable<RegistrationInner> createOrUpdateAsync(String resourceGroup, String registrationName, RegistrationParameterInner token) {
     ...
     * @return the observable to the RegistrationInner object
     */
    public Observable<ServiceResponse<RegistrationInner>> createOrUpdateWithServiceResponseAsync(String resourceGroup, String registrationName, RegistrationParameterInner token) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroup == null) {
