...
import com.microsoft.azure.management.notificationhubs.ErrorResponseException;
...
public class OperationsInner {
     ...
     */
    public OperationsInner(Retrofit retrofit, NotificationHubsManagementClientImpl client) {
    ...
    interface OperationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.notificationhubs.Operations list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.notificationhubs.Operations listNext" })
        @GET
