...
public class NotificationHubsInner {
    ...
    interface NotificationHubsService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.notificationhubs.NotificationHubs getAuthorizationRule" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.notificationhubs.NotificationHubs list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.notificationhubs.NotificationHubs listAuthorizationRules" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.notificationhubs.NotificationHubs listKeys" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.notificationhubs.NotificationHubs regenerateKeys" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.notificationhubs.NotificationHubs getPnsCredentials" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.notificationhubs.NotificationHubs listNext" })
        @GET
        Observable<Response<ResponseBody>> listNext(@Url String nextUrl, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.notificationhubs.NotificationHubs listAuthorizationRulesNext" })
        @GET
     ...
     */
    public NotificationHubResourceInner createOrUpdate(String resourceGroupName, String namespaceName, String notificationHubName, NotificationHubCreateOrUpdateParametersInner parameters) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<NotificationHubResourceInner> createOrUpdateAsync(String resourceGroupName, String namespaceName, String notificationHubName, NotificationHubCreateOrUpdateParametersInner parameters, final ServiceCallback<NotificationHubResourceInner> serviceCallback) {
     ...
     */
    public Observable<NotificationHubResourceInner> createOrUpdateAsync(String resourceGroupName, String namespaceName, String notificationHubName, NotificationHubCreateOrUpdateParametersInner parameters) {
     ...
     * @return the observable to the NotificationHubResourceInner object
     */
    public Observable<ServiceResponse<NotificationHubResourceInner>> createOrUpdateWithServiceResponseAsync(String resourceGroupName, String namespaceName, String notificationHubName, NotificationHubCreateOrUpdateParametersInner parameters) {
        if (resourceGroupName == null) {
            throw new IllegalArgumentException("Parameter resourceGroupName is required and cannot be null.");
        }
        if (namespaceName == null) {
    ...
    public Observable<ServiceResponse<NotificationHubResourceInner>> patchWithServiceResponseAsync(String resourceGroupName, String namespaceName, String notificationHubName) {
        ...
        final NotificationHubPatchParametersInner parameters = null;
