...
public class EntitiesInner {
    ...
    public Observable<ServiceResponse<Page<EntityInfoInner>>> beginListSinglePageAsync() {
        ...
        final String groupName = null;
        final String cacheControl = null;
        return service.beginList(this.client.apiVersion(), skiptoken, skip, top, select, search, filter, view, groupName, cacheControl, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<EntityInfoInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<EntityInfoInner>>> call(Response<ResponseBody> response) {
                    try {
     ...
     * @return the PagedList&lt;EntityInfoInner&gt; object if successful.
     */
    public PagedList<EntityInfoInner> beginList(final String skiptoken, final Integer skip, final Integer top, final String select, final String search, final String filter, final String view, final String groupName, final String cacheControl) {
        ServiceResponse<Page<EntityInfoInner>> response = beginListSinglePageAsync(skiptoken, skip, top, select, search, filter, view, groupName, cacheControl).toBlocking().single();
        return new PagedList<EntityInfoInner>(response.body()) {
            @Override
            public Page<EntityInfoInner> nextPage(String nextPageLink) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<EntityInfoInner>> beginListAsync(final String skiptoken, final Integer skip, final Integer top, final String select, final String search, final String filter, final String view, final String groupName, final String cacheControl, final ListOperationCallback<EntityInfoInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
            beginListSinglePageAsync(skiptoken, skip, top, select, search, filter, view, groupName, cacheControl),
            new Func1<String, Observable<ServiceResponse<Page<EntityInfoInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<EntityInfoInner>>> call(String nextPageLink) {
     ...
     * @return the observable to the PagedList&lt;EntityInfoInner&gt; object
     */
    public Observable<Page<EntityInfoInner>> beginListAsync(final String skiptoken, final Integer skip, final Integer top, final String select, final String search, final String filter, final String view, final String groupName, final String cacheControl) {
        return beginListWithServiceResponseAsync(skiptoken, skip, top, select, search, filter, view, groupName, cacheControl)
            .map(new Func1<ServiceResponse<Page<EntityInfoInner>>, Page<EntityInfoInner>>() {
                @Override
                public Page<EntityInfoInner> call(ServiceResponse<Page<EntityInfoInner>> response) {
                    return response.body();
     ...
     * @return the observable to the PagedList&lt;EntityInfoInner&gt; object
     */
    public Observable<ServiceResponse<Page<EntityInfoInner>>> beginListWithServiceResponseAsync(final String skiptoken, final Integer skip, final Integer top, final String select, final String search, final String filter, final String view, final String groupName, final String cacheControl) {
        return beginListSinglePageAsync(skiptoken, skip, top, select, search, filter, view, groupName, cacheControl)
            .concatMap(new Func1<ServiceResponse<Page<EntityInfoInner>>, Observable<ServiceResponse<Page<EntityInfoInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<EntityInfoInner>>> call(ServiceResponse<Page<EntityInfoInner>> page) {
                    String nextPageLink = page.body().nextPageLink();
     ...
     * @return the PagedList&lt;EntityInfoInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<EntityInfoInner>>> beginListSinglePageAsync(final String skiptoken, final Integer skip, final Integer top, final String select, final String search, final String filter, final String view, final String groupName, final String cacheControl) {
        if (this.client.apiVersion() == null) {
            throw new IllegalArgumentException("Parameter this.client.apiVersion() is required and cannot be null.");
        }
        return service.beginList(this.client.apiVersion(), skiptoken, skip, top, select, search, filter, view, groupName, cacheControl, this.client.acceptLanguage(), this.client.userAgent())
