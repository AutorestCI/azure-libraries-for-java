...
public class OperationsInner {
     ...
     */
    public OperationsInner(Retrofit retrofit, IotCentralClientImpl client) {
    ...
    interface OperationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.iotcentral.Operations list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.iotcentral.Operations listNext" })
        @GET
    ...
    private ServiceResponse<PageImpl<OperationInner>> listDelegate(Response<ResponseBody> response) throws ErrorDetailsException, IOException {
