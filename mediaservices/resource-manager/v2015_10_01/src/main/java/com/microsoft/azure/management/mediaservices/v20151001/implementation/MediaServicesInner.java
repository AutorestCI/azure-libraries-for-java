...
import com.microsoft.azure.management.mediaservices.v20151001.ApiErrorException;
import com.microsoft.azure.management.mediaservices.v20151001.CheckNameAvailabilityInput;
import com.microsoft.azure.management.mediaservices.v20151001.KeyType;
import com.microsoft.azure.management.mediaservices.v20151001.RegenerateKeyInput;
import com.microsoft.azure.management.mediaservices.v20151001.SyncStorageKeysInput;
...
public class MediaServicesInner implements InnerSupportsGet<MediaServiceInner>, InnerSupportsDelete<Void> {
    ...
    interface MediaServicesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.v20151001.MediaServices checkNameAvailability" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.v20151001.MediaServices listByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.v20151001.MediaServices getByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.v20151001.MediaServices create" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.v20151001.MediaServices delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.v20151001.MediaServices update" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.v20151001.MediaServices regenerateKey" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.v20151001.MediaServices listKeys" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.v20151001.MediaServices syncStorageKeys" })
