...
import com.microsoft.azure.management.mediaservices.v20183030preview.CheckNameAvailabilityInput;
...
public class LocationsInner {
    ...
    interface LocationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mediaservices.v20183030preview.Locations checkNameAvailability" })
