...
public class ReplicationSummaryInner {
     ...
     * @return the ReplicationSummaryInner object itself.
     */
    public ReplicationSummaryInner withStatus(HealthStatus status) {
        this.status = status;
        return this;
    }
     ...
     * @return the ReplicationSummaryInner object itself.
     */
    public ReplicationSummaryInner withServiceId(UUID serviceId) {
     ...
     * @return the ReplicationSummaryInner object itself.
     */
    public ReplicationSummaryInner withServiceMemberId(UUID serviceMemberId) {
