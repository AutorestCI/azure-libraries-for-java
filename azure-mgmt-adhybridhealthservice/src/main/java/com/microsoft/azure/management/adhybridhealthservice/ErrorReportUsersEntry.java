...
public class ErrorReportUsersEntry {
     ...
     * @return the ErrorReportUsersEntry object itself.
     */
    public ErrorReportUsersEntry withUserId(String userId) {
        this.userId = userId;
        return this;
    }
     ...
     * @return the ErrorReportUsersEntry object itself.
     */
    public ErrorReportUsersEntry withIpAddress(String ipAddress) {
     ...
     * @return the ErrorReportUsersEntry object itself.
     */
    public ErrorReportUsersEntry withLastUpdated(DateTime lastUpdated) {
     ...
     * @return the ErrorReportUsersEntry object itself.
     */
    public ErrorReportUsersEntry withUniqueIdAddresses(String uniqueIdAddresses) {
     ...
     * @return the ErrorReportUsersEntry object itself.
     */
    public ErrorReportUsersEntry withTotalErrorAttempts(Integer totalErrorAttempts) {
