...
public class ServiceProperties {
     ...
     */
    public ServiceProperties withId(String id) {
        this.id = id;
        return this;
    }
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withActiveAlerts(Integer activeAlerts) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withAdditionalInformation(String additionalInformation) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withCreatedDate(DateTime createdDate) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withCustomNotificationEmails(List<String> customNotificationEmails) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withDisabled(Boolean disabled) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withHealth(String health) {
        this.health = health;
        return this;
    }
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withLastDisable(DateTime lastDisable) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withLastUpdated(DateTime lastUpdated) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withMonitoringConfigurationsComputed(Object monitoringConfigurationsComputed) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withMonitoringConfigurationsCustomized(Object monitoringConfigurationsCustomized) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withNotificationEmailEnabled(Boolean notificationEmailEnabled) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withNotificationEmailEnabledForGlobalAdmins(Boolean notificationEmailEnabledForGlobalAdmins) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withNotificationEmails(List<String> notificationEmails) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withOriginalDisabledState(Boolean originalDisabledState) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withResolvedAlerts(Integer resolvedAlerts) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withServiceId(String serviceId) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withServiceName(String serviceName) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withSignature(String signature) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withSimpleProperties(Object simpleProperties) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withTenantId(String tenantId) {
     ...
     * @return the ServiceProperties object itself.
     */
    public ServiceProperties withType(String type) {
        this.type = type;
        return this;
    }
