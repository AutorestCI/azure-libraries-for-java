...
public class PolicyAssignmentsInner implements InnerSupportsDelete<PolicyAssignmentInner>, InnerSupportsListing<PolicyAssignmentInner> {
     ...
     * This operation retrieves the list of all policy assignments that apply to the given resource group in the given subscription that match the given $filter. Valid values for $filter are: 'atScope()' or 'policyDefinitionId eq '{value}''. If $filter is not provided, the returned list includes all policy assignments that apply to the resource group, including any that might apply from higher-level scopes that contain the given resource group. If $filter=atScope() is provided, the returned list includes only applicable policy assignments created with that resource group as their scope. If $filter=policyDefinitionId eq '{value}' is provided, the returned list includes only applicable policy assignments that enforce the policy definition whose id is {value}.
     *
     ...
     *
     * @param resourceGroupName The name of the resource group that contains policy assignments.
     * @param filter The filter to apply on the operation. Valid values for $filter are: 'atScope()' or 'policyDefinitionId eq '{value}''.
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @throws ErrorResponseException thrown if the request is rejected by server
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent
     * @return the PagedList&lt;PolicyAssignmentInner&gt; object if successful.
    ...
    ServiceResponse<PageImpl<PolicyAssignmentInner>> * @param filter The filter to apply on the operation. Valid values for $filter are: 'atScope()' or 'policyDefinitionId eq '{value}''.
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @return the PagedList&lt;PolicyAssignmentInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
     ...
     * This operation retrieves the list of all policy assignments that apply to the specified resource in the given resource group and subscription, that match the given $filter. Valid values for $filter are: 'atScope()' or 'policyDefinitionId eq '{value}''. If $filter is not provided, the returned list includes all policy assignments that apply to the resource group, including any that might apply from higher-level scopes that contain the given resource group. If $filter=atScope() is provided, the returned list includes only applicable policy assignments created with that resource as their scope. If $filter=policyDefinitionId eq '{value}' is provided, the returned list includes only applicable policy assignments that enforce the policy definition whose id is {value}. Three parameters plus the resource name are used to identify a specific resource. If the resource is not part of a parent resource (the more common case), the parent resource path should not be provided (or provided as ''). For example a web app could be specified as ({resourceProviderNamespace} == 'Microsoft.Web', {parentResourcePath} == '', {resourceType} == 'sites', {resourceName} == 'MyWebApp'). If the resource is part of a parent resource, then all parameters should be provided. For example a virtual machine DNS name could be specified as ({resourceProviderNamespace} == 'Microsoft.Compute', {parentResourcePath} == 'virtualMachines/MyVirtualMachine', {resourceType} == 'domainNames', {resourceName} == 'MyComputerName'). A convenient alternative to providing the namespace and type name separately is to provide both in the {resourceType} parameter, format: ({resourceProviderNamespace} == '', {parentResourcePath} == '', {resourceType} == 'Microsoft.Web/sites', {resourceName} == 'MyWebApp').
     *
     ...
     * This operation retrieves the list of all policy assignments that apply to the given subscription that match the given $filter. Valid values for $filter are: 'atScope()' or 'policyDefinitionId eq '{value}''. If $filter is not provided, the returned list includes all policy assignments that apply to the subscription, including any that might apply from management groups that contain the given subscription. If $filter=atScope() is provided, the returned list includes only applicable policy assignments created with that subscription as their scope. If $filter=policyDefinitionId eq '{value}' is provided, the returned list includes only applicable policy assignments that enforce the policy definition whose id is {value}.
     *
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @throws ErrorResponseException thrown if the request is rejected by server
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent
